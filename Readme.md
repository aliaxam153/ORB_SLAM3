...
Running ROS example: Download a rosbag (e.g. V1_02_medium.bag) from the [EuRoC dataset](https://www.research-collection.ethz.ch/entities/researchdata/bcaf173e-5dac-484b-bc37-faf97a594f1f) and paste in the directory ```home/user_name/```.
